...
- Les tâches runtime de `midi.py` (test end-to-end sur vraies lampes, rate-limit du beat pulse via UDP realtime, test MPE, Link refinement, MIDI 2.0) sont suivies dans [openlamp/wled-midi TASKS.md](https://github.com/openlamp/openlamp-spec-midi/blob/main/TASKS.md) — le moteur est l'implémentation de référence de cette convention.
